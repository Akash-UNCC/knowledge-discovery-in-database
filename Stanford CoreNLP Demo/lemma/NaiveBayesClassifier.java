...
public class NaiveBayesClassifier {
	...
	public static void main(String[] args) throws IOException {
		...
		String positive = ReadPositive(System.getProperty("user.dir")+"//"+"positivefile.txt");
		String negative = ReadPositive(System.getProperty("user.dir")+"//"+"negativefile.txt");
	...
	private static List Preprocessing(String positive) throws IOException {
		...
		// great performances and thrilling experience -pos
